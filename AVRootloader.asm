...
;.include "m1284def.inc"				; ATmega1284
...
;.include "m324Adef.inc"				; ATmega324A
...
;.include "m3250PAdef.inc"				; ATmega3250PA
;.include "m325def.inc"					; ATmega325
;.include "m325Adef.inc"				; ATmega325A
;.include "m325PAdef.inc"				; ATmega325PA
...
;.include "m3290PAdef.inc"				; ATmega3290PA
;.include "m329def.inc"					; ATmega329
;.include "m329Adef.inc"				; ATmega329A
;.include "m329PAdef.inc"				; ATmega329PA
...
;.include "m8U2def.inc					; ATmega8U2
;.include "pwm1def.inc"					; AT90PWM1
...
;.include "pwm81def.inc"				; AT90PWM81
...
.ifndef SREG
.error "Select device by Debug->Select Platform and Device... "
.error "as well as commenting out according def.inc-file !"
.endif

.ifndef PageSize
.error "Device doesn't support Bootloader !"
.else

#message "Compiling for" __PART_NAME__


; set following .equ to 0/1 to de/activate....
...
; now scroll down to the end of this file to configure BootSign and BootMsg

.if UseCrypt && (UseSRAM || !UseCryptFLASH || !UseCryptE2)
.message "WARNING: current settings compromise security !"
.endif
...
.if UseSaveMCUSR || UseBootMode
		xin		paral, MCUSR
.if UseSaveMCUSR
		push	paral				; save old MCUSR on top of stack
...
;		ori		cmdl, (1 << WDE) | (1 << WDCE)
		...
		xout    MCUSR, zerol		; WDRF must be explicitely cleared to take changes on WDT
...
.if PageSize * 2 > 256
.error "PageSize is greater than 256 bytes, check programming loops"
.endif
